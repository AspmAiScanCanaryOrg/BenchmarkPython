...
def init(app):
	...
	@app.route('/benchmark/weakrand-03/BenchmarkTest01045', methods=['GET'])
	def BenchmarkTest01045_get():
		return BenchmarkTest01045_post()

	@app.route('/benchmark/weakrand-03/BenchmarkTest01045', methods=['POST'])
